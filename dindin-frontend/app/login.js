      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.subtitle}>Sentimos sua{" "}
                    <Text style={styles.purpleText}>falta!</Text>
                </Text>
                ...
                <View style={styles.bottomContainer}>
                    <Text style={styles.bottomText}>Por que{"\n"}
                        <Text style={styles.bottomText}>sumiu?{"\n"}</Text>
                        <Text style={styles.bottomText}>Sentimos{"\n"}</Text>
                        <Text style={styles.purpleText1}>saudade.</Text>
                    </Text>

                    <TouchableOpacity style={styles.button} onPress={handleLogin} disable={isLoading}>
                      {isLoading ? (
